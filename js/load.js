...
class Indexador {
    ...
    readFiles() {
        var webs = ["index.html", "catalogoPerros.html", "github.html", "multimedia.html", "sew.html"];
    ...
    indexar(webs,indexador) {
        for (let i = 0; i < webs.length; i++) {
            $.get(webs[i], function (data) {
                ...
                indexador.addDataToTable(datos, webs[i], "h1");
                indexador.addDataToTable(datos, webs[i], "h3");
                indexador.addDataToTable(datos, webs[i], "h4");
                indexador.addDataToTable(datos, webs[i], "li");
            }, "html");
        }
    }
